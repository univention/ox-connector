...
translation=univention.admin.localization.translation('univention.admin.handlers.oxmail.oxfetchmailmulti')
_=translation.translate

module='oxmail/oxfetchmailmulti'
...
childs=False
short_description=_('OX Mail: Fetchmail Multi Drop')
long_description=''
...
property_descriptions={
	...
	'localdomainname': univention.admin.property(
			short_description=_('Space-separated list of local domain names - leave empty for all local domains'),
			long_description='',
			syntax=univention.admin.syntax.string,
			multivalue=0,
			dontsearch=1,
	...
	'envelopeheader': univention.admin.property(
			short_description=_('Envelope header'),
			long_description='',
			syntax=univention.admin.syntax.oxFetchmailEnvelope,
			multivalue=0,
			required=1,
			may_change=1,
			identifies=0
		),
	'qmailprefix': univention.admin.property(
			short_description=_('Virtual qmail prefix'),
			long_description='',
			syntax=univention.admin.syntax.string,
			multivalue=0,
			required=0,
...
mapping.register('localdomainname', 'localDomainName', None, univention.admin.mapping.ListToString)
...
mapping.register('envelopeheader', 'envelopeHeader', None, univention.admin.mapping.ListToString)
mapping.register('qmailprefix', 'qmailPrefix', None, univention.admin.mapping.ListToString)
...
class object(univention.admin.handlers.simpleLdap):
	...
	def _ldap_addlist(self):
		...
		al=[]
		ocs.append('top')
		ocs.append('oxFetchmailMultiDrop')
...
def lookup(co, lo, filter_s, base='', superordinate=None, scope='sub', unique=0, required=0, timeout=-1, sizelimit=0):
	filter=univention.admin.filter.conjunction('&', [
		...
		univention.admin.filter.expression('objectClass', 'oxFetchmailMultiDrop')
		])
...
def identify(dn, attr, canonical=0):
	return 'oxFetchmailMultiDrop' in attr.get('objectClass', [])
